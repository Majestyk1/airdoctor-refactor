...
function ServiceCard({ title, description, icon = 'wrench', link = '/', linkText = 'Learn More' }) {
  ...
  return (
    <div className="service-card border rounded-lg p-6 bg-white hover:shadow-md transition-shadow flex flex-col h-full">
      ...
      <Link to={link} className="service-card__link mt-auto inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium transition-colors no-underline" aria-label={linkText} tabIndex="0">
        {linkText}
