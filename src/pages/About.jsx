  ...
  return (
    <main className="about-page bg-white min-h-screen w-full overflow-x-hidden">
      ...
      <section className="about-cta py-12 bg-gradient-to-br from-blue-100 via-white to-blue-200 text-center">
        <div className="about-cta__container container mx-auto px-4 max-w-2xl transition-all duration-300 rounded-2xl bg-white/60 backdrop-blur-xl shadow-lg shadow-blue-200/40 hover:bg-gradient-to-tr hover:from-blue-100 hover:to-white hover:bg-white/70 focus-within:bg-white/70">
